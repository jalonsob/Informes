...
def read_options():
    ...
    parser.add_option("-j","--dbprojects",
                      action="store",
                      dest="dbprojects",
...
def data_source_increment_activity(opts, people_out, affs_out):
    ...
    qaforums_dbcon = QAForumsQuery(opts.dbuser, opts.dbpassword, opts.dbqaforums, opts.dbidentities,port=opts.port,projects_db=opts.dbprojects)
    irc_dbcon = IRCQuery(opts.dbuser, opts.dbpassword, opts.dbirc, opts.dbidentities,port=opts.port,projects_db=opts.dbprojects)
...
def releases_info(startdate, enddate, project, opts, people_out, affs_out):
    ...
    #SCR Report
    print opts.dbuser, opts.dbpassword, opts.dbreview, opts.dbidentities,opts.port,opts.dbprojects
    scr_dbcon = SCRQuery(opts.dbuser, opts.dbpassword, opts.dbreview, opts.dbidentities,port=opts.port,projects_db=opts.dbprojects)
